...
app.use('/api-broker/analogInputValues', require('./routes/api-broker/analogInputValues'));
app.use('/api-broker/analogOutputValues', require('./routes/api-broker/analogOutputValues'));
