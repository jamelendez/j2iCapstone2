...
class Di3modal extends Component {
    ...
    onSubmit = (newName, newStatus, newAliasOFF, newAliasON) => {
        if (this.state.toAll) {
            ...
            const currentName = this.props.di1.di[2].name;
            const currentAliasOFF = this.props.di1.di[2].aliasOFF;
            const currentAliasON = this.props.di1.di[2].aliasON;
            console.log("currentName: " + currentName);
            if (newName == '') {
                newName = currentName
            }
            ...
            this.props.setChannelDiInfo(updatedChannel, 3);
            this.props.sendChannelsStatusToMQTTBroker();
        }
