...
class Di4modal extends Component {
    ...
    onSubmit = (e) => {
        ...
        if (this.state.toAll) {
            ...
            this.props.setDIChannelName(this.state.name, 4);
            this.setState({ nameChanged: false });
            if (this.state.aliasOFF !== '') this.props.setDIChannelAliasOFF(this.state.aliasOFF, 4);
            if (this.state.aliasON !== '') this.props.setDIChannelAliasON(this.state.aliasON, 4);
            if (this.state.status === false) {
                this.props.setDIChannelStatus(this.state.aliasOFF, 4);
            }
            else {
                this.props.setDIChannelStatus(this.state.aliasON, 4);
            }
        }
    ...
    render() {
        ...
        const { name } = this.props.di1.di.find(channel => channel.ch === 4);
                    ...
                    <ModalBody>
                        <Form onSubmit={this.onSubmit}>
                            ...
                            <FormGroup>
                                ...
                                <Input name="name" id="aliasName" placeholder="DI-4" onChange={this.onChange} />
