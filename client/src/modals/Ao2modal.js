...
class Ao2modal extends Component {
    state = {
        modal: false,
        name: 'AO-2',
        status: false,
    ...
    onSubmit = (e) => {
        ...
        this.props.setAOChannelName(this.state.name, 2);
        if (this.state.status === false) {
            this.props.setAOChannelStatus('Disabled', 2);
        }
        else {
            this.props.setAOChannelStatus('Enabled', 2);
        }
        this.toggle();
    }
    ...
    render() {
        const { name } = this.props.ao1.ao.find(channel => channel.ch === 2);
        return (
            <div>
                    ...
                    <ModalBody>
                        <Form onSubmit={this.onSubmit}>
                            ...
                            <FormGroup>
                                ...
                                <Input name="name" id="aliasName" placeholder="AO-2" onChange={this.onChange} />
