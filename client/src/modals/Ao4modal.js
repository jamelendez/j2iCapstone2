...
class Ao4modal extends Component {
    ...
    onSubmit = (e) => {
        ...
        this.props.setAOChannelName(this.state.name, 4);
        if (this.state.status === false) {
            this.props.setAOChannelStatus('Disabled', 4);
        }
        else {
            this.props.setAOChannelStatus('Enabled', 4);
        }
        this.toggle();
    }
    ...
    render() {
        const { name } = this.props.ao1.ao.find(channel => channel.ch === 4);
        return (
            <div>
                    ...
                    <ModalBody>
                        <Form onSubmit={this.onSubmit}>
                            ...
                            <FormGroup>
                                ...
                                <Input name="name" id="aliasName" placeholder="AO-4" onChange={this.onChange} />
