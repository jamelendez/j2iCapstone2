...
class Ai3modal extends Component {
    state = {
        modal: false,
        name: 'AI-3',
        status: false,
    ...
    onSubmit = (e) => {
        ...
        this.props.setAIChannelName(this.state.name, 3);
        if (this.state.status === false) {
            this.props.setAIChannelStatus('Disabled', 3);
        }
        else {
            this.props.setAIChannelStatus('Enabled', 3);
        }
        if (this.state.pointSlopeFormula) {
            this.props.calculateAutoScalling(this.state.n1, this.state.n2, this.state.m1, this.state.m2, this.props.ai1.ai[2].value, 3);
        }

        if (this.state.slopeIntercept) {
            const result = +(this.state.M * this.props.ai1.ai[2].value) + +this.state.D;
            this.props.setAIChannelSlopeInterceptResult(result, 3);
        }
        ...
        return (
            <div>
                ...
                <Modal
                    ...
                    toggle={this.toggle}
                >
                    <ModalHeader toggle={this.toggle}>AI Channel 3 Settings</ModalHeader>
                    <ModalBody>
                        <Form onSubmit={this.onSubmit}>
                            ...
                            <FormGroup>
                                ...
                                <Input name="name" id="aliasName" placeholder="AI-3" onChange={this.onChange} />
