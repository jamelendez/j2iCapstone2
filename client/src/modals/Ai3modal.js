...
class Ai3modal extends Component {
    ...
    onSubmit = (newName) => {
        ...
        const currentName = this.props.ai1.ai[2].name;
        if (newName == '') {
            newName = currentName
        }
        const updatedChannel =
        {
            _id: '5fbdb99baae376e8250b2462',
            name: newName,
            status: this.state.status,
        }
        this.props.setChannelAiInfo(updatedChannel, 3);
                    ...
                    <ModalBody>
                        <Form>
                            ...
                            <FormGroup>
                                ...
                                <Input name="name" id="name" placeholder="AI-3" onChange={this.onChange} />
