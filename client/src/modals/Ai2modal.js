...
class Ai2modal extends Component {
    state = {
        modal: false,
        name: 'AI-2',
        status: false,
    ...
    onSubmit = (e) => {
        ...
        this.props.setAIChannelName(this.state.name, 2);
        if (this.state.status === false) {
            this.props.setAIChannelStatus('Disabled', 2);
        }
        else {
            this.props.setAIChannelStatus('Enabled', 2);
        }
        if (this.state.pointSlopeFormula) {
            this.props.calculateAutoScalling(this.state.n1, this.state.n2, this.state.m1, this.state.m2, this.props.ai1.ai[1].value, 2);
        }

        if (this.state.slopeIntercept) {
            const result = +(this.state.M * this.props.ai1.ai[1].value) + +this.state.D;
            this.props.setAIChannelSlopeInterceptResult(result, 2);
        }
    ...
    render() {
        const { name } = this.props.ai1.ai.find(channel => channel.ch === 2);
                    ...
                    <ModalBody>
                        <Form onSubmit={this.onSubmit}>
                            ...
                            <FormGroup>
                                ...
                                <Input name="name" id="aliasName" placeholder="AI-2" onChange={this.onChange} />
